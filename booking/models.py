...
class Table(models.Model):
    ...
    status = models.CharField('Статус', max_length=30, choices=STATUS_CHOICES, default='свободный')
...
class Reservation(models.Model):
    ...
    status = models.CharField('Статус', max_length=30, default='забронирован')
...
class Order(models.Model):
    ...
    status = models.CharField('Статус', max_length=30, default='открыт')
